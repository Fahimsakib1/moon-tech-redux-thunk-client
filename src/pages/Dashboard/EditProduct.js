...
import editProductData from "../../redux/thunk/products/getProductDataByID";
import updateProductDataByID from "../../redux/thunk/products/updateProductDataByID";
...
const EditProduct = () => {
    ...
    console.log("State on Edit Product Page", state.product.products);
    const { _id, brand, image, model, price, rating, status, spec, keyFeature } = state.product.products
    ...
    const submitAfterEdit = (data) => {
        ...
        dispatch(updateProductDataByID(_id, product));
        console.log("ID", _id, "Edit Product Data", product);
        reset();
    };
